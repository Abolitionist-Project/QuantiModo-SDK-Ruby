...
module SwaggerClient
  class CommonVariableRelationshipApi
    ...
    # @option opts [Integer] :up_votes Number of users who feel that there is a plausible causal relationship between the predictor and outcome variables.
    # @option opts [Integer] :down_votes Number of users who do not feel that there is a plausible causal relationship between the predictor and outcome variables.
    ...
    # @option opts [Integer] :number_of_users Number of users whose data was aggregated to obtain this relationship
    # @option opts [String] :data_source data_source
    ...
    def common_variable_relationships_get(opts = {})
      data, status_code, headers = common_variable_relationships_get_with_http_info(opts)
      return data
    end
    ...
    # @option opts [Integer] :offset OFFSET says to skip that many rows before beginning to return rows to the client. OFFSET 0 is the same as omitting the OFFSET clause. If both OFFSET and LIMIT appear, then OFFSET rows are skipped before starting to count the LIMIT rows that are returned.
    # @option opts [String] :sort Sort by given field. If the field is prefixed with &#39;-&#39;, it will sort in descending order.
    # @return [Array<(inline_response_200_12, Fixnum, Hash)>] inline_response_200_12 data, response status code and response headers
    def common_variable_relationships_get_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: CommonVariableRelationshipApi#common_variable_relationships_get ..."
      end
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CommonVariableRelationshipApi#common_variable_relationships_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [String] :access_token User&#39;s OAuth2 access token
    # @option opts [CommonVariableRelationship] :body CommonVariableRelationship that should be stored
    # @return [inline_response_200_13]
    def common_variable_relationships_post(opts = {})
      data, status_code, headers = common_variable_relationships_post_with_http_info(opts)
      return data
    end
    ...
    # @option opts [String] :access_token User&#39;s OAuth2 access token
    # @option opts [CommonVariableRelationship] :body CommonVariableRelationship that should be stored
    # @return [Array<(inline_response_200_13, Fixnum, Hash)>] inline_response_200_13 data, response status code and response headers
    def common_variable_relationships_post_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: CommonVariableRelationshipApi#common_variable_relationships_post ..."
      end
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CommonVariableRelationshipApi#common_variable_relationships_post\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [String] :access_token User&#39;s OAuth2 access token
    # @return [inline_response_200_13]
    def common_variable_relationships_id_get(id, opts = {})
      data, status_code, headers = common_variable_relationships_id_get_with_http_info(id, opts)
      return data
    end
    ...
    # @option opts [String] :access_token User&#39;s OAuth2 access token
    # @return [Array<(inline_response_200_13, Fixnum, Hash)>] inline_response_200_13 data, response status code and response headers
    def common_variable_relationships_id_get_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: CommonVariableRelationshipApi#common_variable_relationships_id_get ..."
      end
      
      # verify the required parameter 'id' is set
      fail "Missing the required parameter 'id' when calling common_variable_relationships_id_get" if id.nil?
      ...
      data, status_code, headers = @api_client.call_api(:GET, path,
        ...
        :return_type => 'inline_response_200_13')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CommonVariableRelationshipApi#common_variable_relationships_id_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [String] :access_token User&#39;s OAuth2 access token
    # @option opts [CommonVariableRelationship] :body CommonVariableRelationship that should be updated
    # @return [inline_response_200_2]
    def common_variable_relationships_id_put(id, opts = {})
      data, status_code, headers = common_variable_relationships_id_put_with_http_info(id, opts)
      return data
    end
    ...
    def common_variable_relationships_id_put_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: CommonVariableRelationshipApi#common_variable_relationships_id_put ..."
      end
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CommonVariableRelationshipApi#common_variable_relationships_id_put\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [String] :access_token User&#39;s OAuth2 access token
    # @return [inline_response_200_2]
    def common_variable_relationships_id_delete(id, opts = {})
      data, status_code, headers = common_variable_relationships_id_delete_with_http_info(id, opts)
      return data
    end
    ...
    # @option opts [String] :access_token User&#39;s OAuth2 access token
    # @return [Array<(inline_response_200_2, Fixnum, Hash)>] inline_response_200_2 data, response status code and response headers
    def common_variable_relationships_id_delete_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: CommonVariableRelationshipApi#common_variable_relationships_id_delete ..."
      end
      
      # verify the required parameter 'id' is set
      fail "Missing the required parameter 'id' when calling common_variable_relationships_id_delete" if id.nil?
      ...
      data, status_code, headers = @api_client.call_api(:DELETE, path,
        ...
        :return_type => 'inline_response_200_2')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CommonVariableRelationshipApi#common_variable_relationships_id_delete\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
