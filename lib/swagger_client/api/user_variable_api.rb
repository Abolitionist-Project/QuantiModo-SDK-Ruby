...
module SwaggerClient
  class UserVariableApi
    ...
    def user_variables_get(opts = {})
      data, status_code, headers = user_variables_get_with_http_info(opts)
      return data
    end
    ...
    def user_variables_get_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: UserVariableApi#user_variables_get ..."
      end
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: UserVariableApi#user_variables_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def user_variables_post(opts = {})
      data, status_code, headers = user_variables_post_with_http_info(opts)
      return data
    end
    ...
    # @option opts [String] :access_token User&#39;s OAuth2 access token
    # @option opts [UserVariable] :body UserVariable that should be stored
    # @return [Array<(inline_response_200_30, Fixnum, Hash)>] inline_response_200_30 data, response status code and response headers
    def user_variables_post_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: UserVariableApi#user_variables_post ..."
      end
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: UserVariableApi#user_variables_post\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def user_variables_id_get(id, opts = {})
      data, status_code, headers = user_variables_id_get_with_http_info(id, opts)
      return data
    end
    ...
    # @option opts [String] :access_token User&#39;s OAuth2 access token
    # @return [Array<(inline_response_200_30, Fixnum, Hash)>] inline_response_200_30 data, response status code and response headers
    def user_variables_id_get_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: UserVariableApi#user_variables_id_get ..."
      end
      ...
      data, status_code, headers = @api_client.call_api(:GET, path,
        ...
        :return_type => 'inline_response_200_30')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: UserVariableApi#user_variables_id_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def user_variables_id_put(id, opts = {})
      data, status_code, headers = user_variables_id_put_with_http_info(id, opts)
      return data
    end
    ...
    def user_variables_id_put_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: UserVariableApi#user_variables_id_put ..."
      end
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: UserVariableApi#user_variables_id_put\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def user_variables_id_delete(id, opts = {})
      data, status_code, headers = user_variables_id_delete_with_http_info(id, opts)
      return data
    end
    ...
    # @option opts [String] :access_token User&#39;s OAuth2 access token
    # @return [Array<(inline_response_200_2, Fixnum, Hash)>] inline_response_200_2 data, response status code and response headers
    def user_variables_id_delete_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: UserVariableApi#user_variables_id_delete ..."
      end
      ...
      data, status_code, headers = @api_client.call_api(:DELETE, path,
        ...
        :return_type => 'inline_response_200_2')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: UserVariableApi#user_variables_id_delete\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
