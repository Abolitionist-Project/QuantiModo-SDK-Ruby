...
module SwaggerClient
  class MeasurementsApi
    ...
    def self.measurement_sources_get(opts = {})
      ...
      obj = MeasurementSource.new() and obj.build_from_hash(response)
    end
    ...
    def self.measurements_get(variable_name, opts = {})
      ...
      auth_names = ['oauth2']
      response = Swagger::Request.new(:GET, path, {:params => query_params, :headers => header_params, :form_params => form_params, :body => post_body, :auth_names => auth_names}).make.body
      obj = Measurement.new() and obj.build_from_hash(response)
    end
    ...
    def self.measurements_range_get(opts = {})
      ...
      auth_names = ['oauth2']
      response = Swagger::Request.new(:GET, path, {:params => query_params, :headers => header_params, :form_params => form_params, :body => post_body, :auth_names => auth_names}).make.body
      obj = MeasurementRange.new() and obj.build_from_hash(response)
    end
  end
end
