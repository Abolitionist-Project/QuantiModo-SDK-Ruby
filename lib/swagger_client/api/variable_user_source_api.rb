...
module SwaggerClient
  class VariableUserSourceApi
    ...
    def variable_user_sources_get(opts = {})
      data, status_code, headers = variable_user_sources_get_with_http_info(opts)
      return data
    end
    ...
    def variable_user_sources_get_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: VariableUserSourceApi#variable_user_sources_get ..."
      end
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: VariableUserSourceApi#variable_user_sources_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def variable_user_sources_post(opts = {})
      data, status_code, headers = variable_user_sources_post_with_http_info(opts)
      return data
    end
    ...
    # @option opts [String] :access_token User&#39;s OAuth2 access token
    # @option opts [VariableUserSource] :body VariableUserSource that should be stored
    # @return [Array<(inline_response_200_33, Fixnum, Hash)>] inline_response_200_33 data, response status code and response headers
    def variable_user_sources_post_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: VariableUserSourceApi#variable_user_sources_post ..."
      end
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: VariableUserSourceApi#variable_user_sources_post\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def variable_user_sources_id_get(id, source_id, opts = {})
      data, status_code, headers = variable_user_sources_id_get_with_http_info(id, source_id, opts)
      return data
    end
    ...
    # @option opts [String] :access_token User&#39;s OAuth2 access token
    # @return [Array<(inline_response_200_33, Fixnum, Hash)>] inline_response_200_33 data, response status code and response headers
    def variable_user_sources_id_get_with_http_info(id, source_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: VariableUserSourceApi#variable_user_sources_id_get ..."
      end
      ...
      data, status_code, headers = @api_client.call_api(:GET, path,
        ...
        :return_type => 'inline_response_200_33')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: VariableUserSourceApi#variable_user_sources_id_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def variable_user_sources_id_put(id, source_id, opts = {})
      data, status_code, headers = variable_user_sources_id_put_with_http_info(id, source_id, opts)
      return data
    end
    ...
    def variable_user_sources_id_put_with_http_info(id, source_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: VariableUserSourceApi#variable_user_sources_id_put ..."
      end
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: VariableUserSourceApi#variable_user_sources_id_put\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def variable_user_sources_id_delete(id, source_id, opts = {})
      data, status_code, headers = variable_user_sources_id_delete_with_http_info(id, source_id, opts)
      return data
    end
    ...
    # @option opts [String] :access_token User&#39;s OAuth2 access token
    # @return [Array<(inline_response_200_2, Fixnum, Hash)>] inline_response_200_2 data, response status code and response headers
    def variable_user_sources_id_delete_with_http_info(id, source_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: VariableUserSourceApi#variable_user_sources_id_delete ..."
      end
      ...
      data, status_code, headers = @api_client.call_api(:DELETE, path,
        ...
        :return_type => 'inline_response_200_2')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: VariableUserSourceApi#variable_user_sources_id_delete\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
