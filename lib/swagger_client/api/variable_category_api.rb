...
module SwaggerClient
  class VariableCategoryApi
    ...
    def variable_categories_get(opts = {})
      data, status_code, headers = variable_categories_get_with_http_info(opts)
      return data
    end
    ...
    # @option opts [Integer] :offset OFFSET says to skip that many rows before beginning to return rows to the client. OFFSET 0 is the same as omitting the OFFSET clause. If both OFFSET and LIMIT appear, then OFFSET rows are skipped before starting to count the LIMIT rows that are returned.
    # @option opts [String] :sort Sort by given field. If the field is prefixed with &#39;-&#39;, it will sort in descending order.
    # @return [Array<(inline_response_200_31, Fixnum, Hash)>] inline_response_200_31 data, response status code and response headers
    def variable_categories_get_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: VariableCategoryApi#variable_categories_get ..."
      end
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: VariableCategoryApi#variable_categories_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def variable_categories_post(opts = {})
      data, status_code, headers = variable_categories_post_with_http_info(opts)
      return data
    end
    ...
    # @option opts [String] :access_token User&#39;s OAuth2 access token
    # @option opts [VariableCategory] :body VariableCategory that should be stored
    # @return [Array<(inline_response_200_32, Fixnum, Hash)>] inline_response_200_32 data, response status code and response headers
    def variable_categories_post_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: VariableCategoryApi#variable_categories_post ..."
      end
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: VariableCategoryApi#variable_categories_post\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def variable_categories_id_get(id, opts = {})
      data, status_code, headers = variable_categories_id_get_with_http_info(id, opts)
      return data
    end
    ...
    # @option opts [String] :access_token User&#39;s OAuth2 access token
    # @return [Array<(inline_response_200_32, Fixnum, Hash)>] inline_response_200_32 data, response status code and response headers
    def variable_categories_id_get_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: VariableCategoryApi#variable_categories_id_get ..."
      end
      ...
      data, status_code, headers = @api_client.call_api(:GET, path,
        ...
        :return_type => 'inline_response_200_32')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: VariableCategoryApi#variable_categories_id_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def variable_categories_id_put(id, opts = {})
      data, status_code, headers = variable_categories_id_put_with_http_info(id, opts)
      return data
    end
    ...
    def variable_categories_id_put_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: VariableCategoryApi#variable_categories_id_put ..."
      end
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: VariableCategoryApi#variable_categories_id_put\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def variable_categories_id_delete(id, opts = {})
      data, status_code, headers = variable_categories_id_delete_with_http_info(id, opts)
      return data
    end
    ...
    # @option opts [String] :access_token User&#39;s OAuth2 access token
    # @return [Array<(inline_response_200_2, Fixnum, Hash)>] inline_response_200_2 data, response status code and response headers
    def variable_categories_id_delete_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: VariableCategoryApi#variable_categories_id_delete ..."
      end
      ...
      data, status_code, headers = @api_client.call_api(:DELETE, path,
        ...
        :return_type => 'inline_response_200_2')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: VariableCategoryApi#variable_categories_id_delete\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
