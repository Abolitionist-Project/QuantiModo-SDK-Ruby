  ...
  class OrganizationsApi
    ...
    def v1_organizations_organization_id_users_post_with_http_info(organization_id, body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: OrganizationsApi.v1_organizations_organization_id_users_post ..."
      end
      # verify the required parameter 'organization_id' is set
      fail ArgumentError, "Missing the required parameter 'organization_id' when calling OrganizationsApi.v1_organizations_organization_id_users_post" if organization_id.nil?
      # verify the required parameter 'body' is set
      fail ArgumentError, "Missing the required parameter 'body' when calling OrganizationsApi.v1_organizations_organization_id_users_post" if body.nil?
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: OrganizationsApi#v1_organizations_organization_id_users_post\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
