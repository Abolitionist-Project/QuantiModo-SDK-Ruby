...
module SwaggerClient
  class ConnectionApi
    ...
    def connections_get(opts = {})
      data, status_code, headers = connections_get_with_http_info(opts)
      return data
    end
    ...
    def connections_get_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: ConnectionApi#connections_get ..."
      end
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ConnectionApi#connections_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def connections_post(opts = {})
      data, status_code, headers = connections_post_with_http_info(opts)
      return data
    end
    ...
    # @option opts [String] :access_token User&#39;s OAuth2 access token
    # @option opts [Connection] :body Connection that should be stored
    # @return [Array<(inline_response_200_14, Fixnum, Hash)>] inline_response_200_14 data, response status code and response headers
    def connections_post_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: ConnectionApi#connections_post ..."
      end
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ConnectionApi#connections_post\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def connections_id_get(id, opts = {})
      data, status_code, headers = connections_id_get_with_http_info(id, opts)
      return data
    end
    ...
    # @option opts [String] :access_token User&#39;s OAuth2 access token
    # @return [Array<(inline_response_200_14, Fixnum, Hash)>] inline_response_200_14 data, response status code and response headers
    def connections_id_get_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: ConnectionApi#connections_id_get ..."
      end
      ...
      data, status_code, headers = @api_client.call_api(:GET, path,
        ...
        :return_type => 'inline_response_200_14')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ConnectionApi#connections_id_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def connections_id_put(id, opts = {})
      data, status_code, headers = connections_id_put_with_http_info(id, opts)
      return data
    end
    ...
    def connections_id_put_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: ConnectionApi#connections_id_put ..."
      end
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ConnectionApi#connections_id_put\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def connections_id_delete(id, opts = {})
      data, status_code, headers = connections_id_delete_with_http_info(id, opts)
      return data
    end
    ...
    # @option opts [String] :access_token User&#39;s OAuth2 access token
    # @return [Array<(inline_response_200_2, Fixnum, Hash)>] inline_response_200_2 data, response status code and response headers
    def connections_id_delete_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: ConnectionApi#connections_id_delete ..."
      end
      ...
      data, status_code, headers = @api_client.call_api(:DELETE, path,
        ...
        :return_type => 'inline_response_200_2')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ConnectionApi#connections_id_delete\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
