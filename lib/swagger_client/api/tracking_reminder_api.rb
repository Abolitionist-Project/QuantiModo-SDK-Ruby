...
module SwaggerClient
  class TrackingReminderApi
    ...
    # @option opts [String] :client_id The ID of the client application which last created or updated this tracking reminder
    # @option opts [Integer] :user_id ID of the user who created a reminder
    # @option opts [Integer] :variable_id Id for the variable to be tracked
    # @option opts [BOOLEAN] :pop_up True if the reminders should appear as a popup notification
    # @option opts [BOOLEAN] :sms True if the reminders should be delivered via SMS
    # @option opts [BOOLEAN] :email True if the reminders should be delivered via email
    # @option opts [BOOLEAN] :notification_bar True if the reminders should appear in the notification bar
    # @option opts [String] :last_reminded ISO 8601 timestamp for the last time a reminder was sent
    # @option opts [String] :last_tracked ISO 8601 timestamp for the last time a measurement was received for this user and variable
    ...
    def tracking_reminders_get(opts = {})
      data, status_code, headers = tracking_reminders_get_with_http_info(opts)
      return data
    end
    ...
    def tracking_reminders_get_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: TrackingReminderApi#tracking_reminders_get ..."
      end
      
      # resource path
      path = "/trackingReminders".sub('{format}','json')
      ...
      query_params[:'pop_up'] = opts[:'pop_up'] if opts[:'pop_up']
      query_params[:'sms'] = opts[:'sms'] if opts[:'sms']
      query_params[:'email'] = opts[:'email'] if opts[:'email']
      query_params[:'notification_bar'] = opts[:'notification_bar'] if opts[:'notification_bar']
      query_params[:'last_reminded'] = opts[:'last_reminded'] if opts[:'last_reminded']
      query_params[:'last_tracked'] = opts[:'last_tracked'] if opts[:'last_tracked']
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: TrackingReminderApi#tracking_reminders_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def tracking_reminders_post(opts = {})
      data, status_code, headers = tracking_reminders_post_with_http_info(opts)
      return data
    end
    ...
    # @option opts [String] :access_token User&#39;s OAuth2 access token
    # @option opts [TrackingReminder] :body TrackingReminder that should be stored
    # @return [Array<(inline_response_200_23, Fixnum, Hash)>] inline_response_200_23 data, response status code and response headers
    def tracking_reminders_post_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: TrackingReminderApi#tracking_reminders_post ..."
      end
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: TrackingReminderApi#tracking_reminders_post\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [String] :access_token User&#39;s OAuth2 access token
    # @return [inline_response_200_23]
    def tracking_reminders_id_get(id, opts = {})
      data, status_code, headers = tracking_reminders_id_get_with_http_info(id, opts)
      return data
    end
    ...
    # @option opts [String] :access_token User&#39;s OAuth2 access token
    # @return [Array<(inline_response_200_23, Fixnum, Hash)>] inline_response_200_23 data, response status code and response headers
    def tracking_reminders_id_get_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: TrackingReminderApi#tracking_reminders_id_get ..."
      end
      
      # verify the required parameter 'id' is set
      fail "Missing the required parameter 'id' when calling tracking_reminders_id_get" if id.nil?
      
      # resource path
      path = "/trackingReminders/{id}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:GET, path,
        ...
        :return_type => 'inline_response_200_23')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: TrackingReminderApi#tracking_reminders_id_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [String] :access_token User&#39;s OAuth2 access token
    # @option opts [TrackingReminder] :body TrackingReminder that should be updated
    # @return [inline_response_200_2]
    def tracking_reminders_id_put(id, opts = {})
      data, status_code, headers = tracking_reminders_id_put_with_http_info(id, opts)
      return data
    end
    ...
    def tracking_reminders_id_put_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: TrackingReminderApi#tracking_reminders_id_put ..."
      end
      
      # verify the required parameter 'id' is set
      fail "Missing the required parameter 'id' when calling tracking_reminders_id_put" if id.nil?
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: TrackingReminderApi#tracking_reminders_id_put\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [String] :access_token User&#39;s OAuth2 access token
    # @return [inline_response_200_2]
    def tracking_reminders_id_delete(id, opts = {})
      data, status_code, headers = tracking_reminders_id_delete_with_http_info(id, opts)
      return data
    end
    ...
    # @option opts [String] :access_token User&#39;s OAuth2 access token
    # @return [Array<(inline_response_200_2, Fixnum, Hash)>] inline_response_200_2 data, response status code and response headers
    def tracking_reminders_id_delete_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: TrackingReminderApi#tracking_reminders_id_delete ..."
      end
      
      # verify the required parameter 'id' is set
      fail "Missing the required parameter 'id' when calling tracking_reminders_id_delete" if id.nil?
      ...
      data, status_code, headers = @api_client.call_api(:DELETE, path,
        ...
        :return_type => 'inline_response_200_2')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: TrackingReminderApi#tracking_reminders_id_delete\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
