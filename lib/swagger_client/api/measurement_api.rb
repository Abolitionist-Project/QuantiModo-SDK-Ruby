...
module SwaggerClient
  class MeasurementApi
    ...
    def measurements_get(opts = {})
      data, status_code, headers = measurements_get_with_http_info(opts)
      return data
    end
    ...
    def measurements_get_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: MeasurementApi#measurements_get ..."
      end
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: MeasurementApi#measurements_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def measurements_post(opts = {})
      data, status_code, headers = measurements_post_with_http_info(opts)
      return data
    end
    ...
    # @option opts [MeasurementPost] :body Measurement that should be stored
    # @return [Array<(inline_response_200_5, Fixnum, Hash)>] inline_response_200_5 data, response status code and response headers
    def measurements_post_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: MeasurementApi#measurements_post ..."
      end
      ...
      data, status_code, headers = @api_client.call_api(:POST, path,
        ...
        :return_type => 'inline_response_200_5')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: MeasurementApi#measurements_post\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def measurements_csv_get(opts = {})
      data, status_code, headers = measurements_csv_get_with_http_info(opts)
      return data
    end
    ...
    def measurements_csv_get_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: MeasurementApi#measurements_csv_get ..."
      end
      ...
      data, status_code, headers = @api_client.call_api(:GET, path,
        ...
        :return_type => 'File')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: MeasurementApi#measurements_csv_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def measurements_request_csv_post(opts = {})
      data, status_code, headers = measurements_request_csv_post_with_http_info(opts)
      return data
    end
    ...
    def measurements_request_csv_post_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: MeasurementApi#measurements_request_csv_post ..."
      end
      ...
      data, status_code, headers = @api_client.call_api(:POST, path,
        ...
        :return_type => 'Integer')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: MeasurementApi#measurements_request_csv_post\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def measurements_id_get(id, opts = {})
      data, status_code, headers = measurements_id_get_with_http_info(id, opts)
      return data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [String] :access_token User&#39;s OAuth2 access token
    # @return [Array<(inline_response_200_20, Fixnum, Hash)>] inline_response_200_20 data, response status code and response headers
    def measurements_id_get_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: MeasurementApi#measurements_id_get ..."
      end
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: MeasurementApi#measurements_id_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def measurements_id_put(id, opts = {})
      data, status_code, headers = measurements_id_put_with_http_info(id, opts)
      return data
    end
    ...
    def measurements_id_put_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: MeasurementApi#measurements_id_put ..."
      end
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: MeasurementApi#measurements_id_put\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def measurements_id_delete(id, opts = {})
      data, status_code, headers = measurements_id_delete_with_http_info(id, opts)
      return data
    end
    ...
    # @option opts [String] :access_token User&#39;s OAuth2 access token
    # @return [Array<(inline_response_200_2, Fixnum, Hash)>] inline_response_200_2 data, response status code and response headers
    def measurements_id_delete_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: MeasurementApi#measurements_id_delete ..."
      end
      ...
      data, status_code, headers = @api_client.call_api(:DELETE, path,
        ...
        :return_type => 'inline_response_200_2')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: MeasurementApi#measurements_id_delete\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
