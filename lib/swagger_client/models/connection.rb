...
module SwaggerClient
  ...
  class Connection
    ...
    attr_accessor :update_requested_at
    ...
    attr_accessor :update_error

    # The time at which the connector was last successfully updated.
    attr_accessor :last_successful_updated_at
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          connect_status == o.connect_status &&
          connect_error == o.connect_error &&
          update_requested_at == o.update_requested_at &&
          update_status == o.update_status &&
          update_error == o.update_error &&
          last_successful_updated_at == o.last_successful_updated_at &&
    ...
    def hash
      [id, user_id, connector_id, connect_status, connect_error, update_requested_at, update_status, update_error, last_successful_updated_at, created_at, updated_at].hash
    end
