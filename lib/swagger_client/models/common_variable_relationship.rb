...
module SwaggerClient
  class CommonVariableRelationship
    ...
    def hash
      [id, confidence_level, confidence_score, direction, duration_of_action, error_message, onset_delay, outcome_variable_id, predictor_variable_id, predictor_unit_id, sinn_rank, strength_score, strength_level, up_votes, down_votes, value_predicting_high_outcome, value_predicting_low_outcome, number_of_users, data_source].hash
    end
