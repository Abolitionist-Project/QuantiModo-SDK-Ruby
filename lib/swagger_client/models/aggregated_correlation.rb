...
module SwaggerClient
  class AggregatedCorrelation
    ...
    # Aggregated QM Score
    attr_accessor :aggregate_qm_score
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          aggregate_qm_score == o.aggregate_qm_score &&
