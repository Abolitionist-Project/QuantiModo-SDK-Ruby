...
module SwaggerClient
  class VariableCategory
    ...
    def hash
      [id, name, filling_value, maximum_allowed_value, minimum_allowed_value, duration_of_action, onset_delay, combination_operation, updated, cause_only, public, outcome, created_at, updated_at, image_url, default_unit_id].hash
    end
