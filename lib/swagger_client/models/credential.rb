...
module SwaggerClient
  ...
  class Credential
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'attr_value')
    ...
    def hash
      [user_id, connector_id, attr_key, attr_value, created_at, updated_at].hash
    end
