...
module SwaggerClient
  class Variable
    ...
    attr_accessor :number_of_unique_values
    ...
    # Number of variables
    attr_accessor :number_of_user_variables
    ...
    attr_accessor :maximum_recorded_value
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          number_of_unique_values == o.number_of_unique_values &&
          skewness == o.skewness &&
          kurtosis == o.kurtosis &&
          status == o.status &&
          ...
          price == o.price &&
          number_of_user_variables == o.number_of_user_variables &&
          outcome == o.outcome &&
          minimum_recorded_value == o.minimum_recorded_value &&
          maximum_recorded_value == o.maximum_recorded_value
    end
