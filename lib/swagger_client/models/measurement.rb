...
module SwaggerClient
  class Measurement
    ...
    attr_accessor :original_unit_id
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          original_unit_id == o.original_unit_id &&
          duration == o.duration &&
          note == o.note &&
          latitude == o.latitude &&
    ...
    def hash
      [id, user_id, client_id, connector_id, variable_id, source_id, start_time, value, unit_id, original_value, original_unit_id, duration, note, latitude, longitude, location, created_at, updated_at, error].hash
    end
