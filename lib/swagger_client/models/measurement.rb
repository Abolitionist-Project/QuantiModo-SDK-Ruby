...
module SwaggerClient
  ...
  class Measurement
    ...
    attr_accessor :stored_abbreviated_unit_name

    # Original Unit of measurement as originally submitted
    attr_accessor :original_abbreviated_unit_name
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'variable')
      ...
      if attributes.has_key?(:'humanTime')
      ...
      if attributes.has_key?(:'storedAbbreviatedUnitName')
        self.stored_abbreviated_unit_name = attributes[:'storedAbbreviatedUnitName']
      end

      if attributes.has_key?(:'originalAbbreviatedUnitName')
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          stored_abbreviated_unit_name == o.stored_abbreviated_unit_name &&
          original_abbreviated_unit_name == o.original_abbreviated_unit_name &&
    ...
    def hash
      [variable, source, start_time, human_time, value, unit, original_value, stored_value, stored_abbreviated_unit_name, original_abbreviated_unit_name, abbreviated_unit_name, note].hash
    end
