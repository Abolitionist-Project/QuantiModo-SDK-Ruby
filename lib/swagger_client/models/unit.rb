...
module SwaggerClient
  ...
  class Unit
    ...
    attr_accessor :conversion_steps
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'abbreviatedName')
      ...
      if attributes.has_key?(:'conversionSteps')
    ...
    def valid?
      ...
      return false if @abbreviated_name.nil?
      return false if @category.nil?
      category_validator = EnumAttributeValidator.new('String', ["Distance", "Duration", "Energy", "Frequency", "Miscellany", "Pressure", "Proportion", "Rating", "Temperature", "Volume", "Weight"])
      return false unless category_validator.valid?(@category)
      return false if @conversion_steps.nil?
      return true
    end
    ...
    def category=(category)
      validator = EnumAttributeValidator.new('String', ["Distance", "Duration", "Energy", "Frequency", "Miscellany", "Pressure", "Proportion", "Rating", "Temperature", "Volume", "Weight"])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          conversion_steps == o.conversion_steps
    end
    ...
    def hash
      [name, abbreviated_name, category, minimum_value, maximum_value, conversion_steps].hash
    end
