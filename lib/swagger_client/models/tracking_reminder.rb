...
module SwaggerClient
  ...
  class TrackingReminder
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'lastReminded')
        self.last_reminded = attributes[:'lastReminded']
      end
      ...
      if attributes.has_key?(:'firstDailyReminderTime')
        self.first_daily_reminder_time = attributes[:'firstDailyReminderTime']
      end

      if attributes.has_key?(:'secondDailyReminderTime')
        self.second_daily_reminder_time = attributes[:'secondDailyReminderTime']
      end

      if attributes.has_key?(:'thirdDailyReminderTime')
        self.third_daily_reminder_time = attributes[:'thirdDailyReminderTime']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          last_reminded == o.last_reminded &&
          last_tracked == o.last_tracked &&
          first_daily_reminder_time == o.first_daily_reminder_time &&
          second_daily_reminder_time == o.second_daily_reminder_time &&
          third_daily_reminder_time == o.third_daily_reminder_time &&
    ...
    def hash
      [id, client_id, user_id, variable_id, default_value, reminder_start_time, reminder_end_time, reminder_sound, reminder_frequency, pop_up, sms, email, notification_bar, last_reminded, last_tracked, first_daily_reminder_time, second_daily_reminder_time, third_daily_reminder_time, start_tracking_date, stop_tracking_date, updated_at, variable_name, variable_category_name, abbreviated_unit_name, combination_operation].hash
    end
