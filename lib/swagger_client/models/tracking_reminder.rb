...
module SwaggerClient
  class TrackingReminder
    ...
    def initialize(attributes = {})
      ...
      if attributes[:'reminder_start_time']
        self.reminder_start_time = attributes[:'reminder_start_time']
      end
      
      if attributes[:'reminder_end_time']
        self.reminder_end_time = attributes[:'reminder_end_time']
      end
      
      if attributes[:'reminder_sound']
        self.reminder_sound = attributes[:'reminder_sound']
      end
      
      if attributes[:'reminder_frequency']
        self.reminder_frequency = attributes[:'reminder_frequency']
      end
      
      if attributes[:'pop_up']
        self.pop_up = attributes[:'pop_up']
      end
      ...
      if attributes[:'notification_bar']
        self.notification_bar = attributes[:'notification_bar']
      end
      
      if attributes[:'last_reminded']
        self.last_reminded = attributes[:'last_reminded']
      end
      
      if attributes[:'last_tracked']
        self.last_tracked = attributes[:'last_tracked']
      end
    ...
    def hash
      [id, client_id, user_id, variable_id, default_value, reminder_start_time, reminder_end_time, reminder_sound, reminder_frequency, pop_up, sms, email, notification_bar, last_reminded, last_tracked, created_at, updated_at].hash
    end
