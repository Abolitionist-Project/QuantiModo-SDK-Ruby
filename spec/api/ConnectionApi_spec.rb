...
# Unit tests for SwaggerClient::ConnectionApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ConnectionApi' do
  before do
    # run before each test
    @instance = SwaggerClient::ConnectionApi.new
  end
  ...
  describe 'test an instance of ConnectionApi' do
    it 'should create an instact of ConnectionApi' do
      @instance.should be_a(SwaggerClient::ConnectionApi)
    end
  end
  ...
  # unit tests for connections_post
  # Store Connection
  # Store Connection
  # @param [Hash] opts the optional parameters
  # @option opts [String] :access_token User&#39;s OAuth2 access token
  ...
  describe 'connections_post test' do
    it "should work" do
      # assertion here
      # should be_a()
      # should be_nil
  ...
  # unit tests for connections_id_get
  # Get Connection
  # Get Connection
  ...
  # @option opts [String] :access_token User&#39;s OAuth2 access token
  # @return [inline_response_200_14]
  describe 'connections_id_get test' do
    it "should work" do
      # assertion here
      # should be_a()
      # should be_nil
  ...
  # unit tests for connections_id_put
  # Update Connection
  # Update Connection
  # @param id id of Connection
  # @param [Hash] opts the optional parameters
  ...
  describe 'connections_id_put test' do
    it "should work" do
      # assertion here
      # should be_a()
      # should be_nil
  ...
  # unit tests for connections_id_delete
  # Delete Connection
  # Delete Connection
  # @param id id of Connection
  # @param [Hash] opts the optional parameters
  # @option opts [String] :access_token User&#39;s OAuth2 access token
  # @return [inline_response_200_2]
  describe 'connections_id_delete test' do
    it "should work" do
      # assertion here
      # should be_a()
      # should be_nil
