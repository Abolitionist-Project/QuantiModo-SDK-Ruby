...
# Unit tests for SwaggerClient::UnitCategoryApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UnitCategoryApi' do
  before do
    # run before each test
    @instance = SwaggerClient::UnitCategoryApi.new
  end
  ...
  describe 'test an instance of UnitCategoryApi' do
    it 'should create an instact of UnitCategoryApi' do
      @instance.should be_a(SwaggerClient::UnitCategoryApi)
    end
  end

  # unit tests for unit_categories_get
  # Get unit categories
  ...
  describe 'unit_categories_get test' do
    it "should work" do
      # assertion here
      # should be_a()
      # should be_nil
  ...
  # unit tests for unit_categories_post
  # Store UnitCategory
  # Store UnitCategory
  # @param [Hash] opts the optional parameters
  # @option opts [String] :access_token User&#39;s OAuth2 access token
  ...
  describe 'unit_categories_post test' do
    it "should work" do
      # assertion here
      # should be_a()
      # should be_nil
  ...
  # unit tests for unit_categories_id_get
  # Get UnitCategory
  # Get UnitCategory
  ...
  # @option opts [String] :access_token User&#39;s OAuth2 access token
  # @return [inline_response_200_25]
  describe 'unit_categories_id_get test' do
    it "should work" do
      # assertion here
      # should be_a()
      # should be_nil
  ...
  # unit tests for unit_categories_id_put
  # Update UnitCategory
  # Update UnitCategory
  # @param id id of UnitCategory
  # @param [Hash] opts the optional parameters
  ...
  describe 'unit_categories_id_put test' do
    it "should work" do
      # assertion here
      # should be_a()
      # should be_nil
  ...
  # unit tests for unit_categories_id_delete
  # Delete UnitCategory
  # Delete UnitCategory
  # @param id id of UnitCategory
  # @param [Hash] opts the optional parameters
  # @option opts [String] :access_token User&#39;s OAuth2 access token
  # @return [inline_response_200_2]
  describe 'unit_categories_id_delete test' do
    it "should work" do
      # assertion here
      # should be_a()
      # should be_nil
