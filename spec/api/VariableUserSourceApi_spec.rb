...
# Unit tests for SwaggerClient::VariableUserSourceApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'VariableUserSourceApi' do
  before do
    # run before each test
    @instance = SwaggerClient::VariableUserSourceApi.new
  end
  ...
  describe 'test an instance of VariableUserSourceApi' do
    it 'should create an instact of VariableUserSourceApi' do
      @instance.should be_a(SwaggerClient::VariableUserSourceApi)
    end
  end

  # unit tests for variable_user_sources_get
  ...
  describe 'variable_user_sources_get test' do
    it "should work" do
      # assertion here
      # should be_a()
      # should be_nil
  ...
  # unit tests for variable_user_sources_post
  ...
  describe 'variable_user_sources_post test' do
    it "should work" do
      # assertion here
      # should be_a()
      # should be_nil
  ...
  # unit tests for variable_user_sources_id_get
  ...
  # @option opts [String] :access_token User&#39;s OAuth2 access token
  # @return [inline_response_200_33]
  describe 'variable_user_sources_id_get test' do
    it "should work" do
      # assertion here
      # should be_a()
      # should be_nil
  ...
  # unit tests for variable_user_sources_id_put
  ...
  describe 'variable_user_sources_id_put test' do
    it "should work" do
      # assertion here
      # should be_a()
      # should be_nil
  ...
  # unit tests for variable_user_sources_id_delete
  ...
  # @option opts [String] :access_token User&#39;s OAuth2 access token
  # @return [inline_response_200_2]
  describe 'variable_user_sources_id_delete test' do
    it "should work" do
      # assertion here
      # should be_a()
      # should be_nil
