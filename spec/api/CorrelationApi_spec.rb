...
# Unit tests for SwaggerClient::CorrelationApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CorrelationApi' do
  before do
    # run before each test
    @instance = SwaggerClient::CorrelationApi.new
  end
  ...
  describe 'test an instance of CorrelationApi' do
    it 'should create an instact of CorrelationApi' do
      @instance.should be_a(SwaggerClient::CorrelationApi)
    end
  end

  # unit tests for correlations_get
  ...
  describe 'correlations_get test' do
    it "should work" do
      # assertion here
      # should be_a()
      # should be_nil
  ...
  # unit tests for correlations_post
  # Store Correlation
  # Store Correlation
  # @param [Hash] opts the optional parameters
  # @option opts [String] :access_token User&#39;s OAuth2 access token
  ...
  describe 'correlations_post test' do
    it "should work" do
      # assertion here
      # should be_a()
      # should be_nil
  ...
  # unit tests for correlations_id_get
  ...
  # @option opts [String] :access_token User&#39;s OAuth2 access token
  # @return [inline_response_200_18]
  describe 'correlations_id_get test' do
    it "should work" do
      # assertion here
      # should be_a()
      # should be_nil
  ...
  # unit tests for correlations_id_put
  # Update Correlation
  # Update Correlation
  # @param id id of Correlation
  # @param [Hash] opts the optional parameters
  ...
  describe 'correlations_id_put test' do
    it "should work" do
      # assertion here
      # should be_a()
      # should be_nil
  ...
  # unit tests for correlations_id_delete
  # Delete Correlation
  # Delete Correlation
  # @param id id of Correlation
  # @param [Hash] opts the optional parameters
  # @option opts [String] :access_token User&#39;s OAuth2 access token
  # @return [inline_response_200_2]
  describe 'correlations_id_delete test' do
    it "should work" do
      # assertion here
      # should be_a()
      # should be_nil
