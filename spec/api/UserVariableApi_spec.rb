...
# Unit tests for SwaggerClient::UserVariableApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UserVariableApi' do
  before do
    # run before each test
    @instance = SwaggerClient::UserVariableApi.new
  end
  ...
  describe 'test an instance of UserVariableApi' do
    it 'should create an instact of UserVariableApi' do
      @instance.should be_a(SwaggerClient::UserVariableApi)
    end
  end

  # unit tests for user_variables_get
  ...
  describe 'user_variables_get test' do
    it "should work" do
      # assertion here
      # should be_a()
      # should be_nil
  ...
  # unit tests for user_variables_post
  # Store UserVariable
  ...
  describe 'user_variables_post test' do
    it "should work" do
      # assertion here
      # should be_a()
      # should be_nil
  ...
  # unit tests for user_variables_id_get
  # Get UserVariable
  # Get UserVariable
  ...
  # @option opts [String] :access_token User&#39;s OAuth2 access token
  # @return [inline_response_200_30]
  describe 'user_variables_id_get test' do
    it "should work" do
      # assertion here
      # should be_a()
      # should be_nil
  ...
  # unit tests for user_variables_id_put
  # Update UserVariable
  # Update UserVariable
  # @param id id of UserVariable
  # @param [Hash] opts the optional parameters
  ...
  describe 'user_variables_id_put test' do
    it "should work" do
      # assertion here
      # should be_a()
      # should be_nil
  ...
  # unit tests for user_variables_id_delete
  # Delete UserVariable
  # Delete UserVariable
  # @param id id of UserVariable
  # @param [Hash] opts the optional parameters
  # @option opts [String] :access_token User&#39;s OAuth2 access token
  # @return [inline_response_200_2]
  describe 'user_variables_id_delete test' do
    it "should work" do
      # assertion here
      # should be_a()
      # should be_nil
