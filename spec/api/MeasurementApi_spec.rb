...
# Unit tests for SwaggerClient::MeasurementApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MeasurementApi' do
  before do
    # run before each test
    @instance = SwaggerClient::MeasurementApi.new
  end
  ...
  describe 'test an instance of MeasurementApi' do
    it 'should create an instact of MeasurementApi' do
      @instance.should be_a(SwaggerClient::MeasurementApi)
    end
  end

  # unit tests for measurements_get
  ...
  describe 'measurements_get test' do
    it "should work" do
      # assertion here
      # should be_a()
      # should be_nil
  ...
  # unit tests for measurements_post
  ...
  # @return [inline_response_200_5]
  describe 'measurements_post test' do
    it "should work" do
      # assertion here
      # should be_a()
      # should be_nil
  ...
  # unit tests for measurements_csv_get
  # Get Measurements CSV
  # Download a CSV containing all user measurements
  # @param [Hash] opts the optional parameters
  # @option opts [String] :access_token User&#39;s OAuth2 access token
  # @return [File]
  describe 'measurements_csv_get test' do
    it "should work" do
      # assertion here
      # should be_a()
      # should be_nil
  ...
  # unit tests for measurements_request_csv_post
  # Post Request for Measurements CSV
  # Use this endpoint to schedule a CSV export containing all user measurements to be emailed to the user within 24 hours.
  # @param [Hash] opts the optional parameters
  # @option opts [String] :access_token User&#39;s OAuth2 access token
  # @return [Integer]
  describe 'measurements_request_csv_post test' do
    it "should work" do
      # assertion here
      # should be_a()
      # should be_nil
  ...
  # unit tests for measurements_id_get
  # Get Measurement
  # Get Measurement
  ...
  describe 'measurements_id_get test' do
    it "should work" do
      # assertion here
      # should be_a()
      # should be_nil
  ...
  # unit tests for measurements_id_put
  # Update Measurement
  # Update Measurement
  # @param id id of Measurement
  # @param [Hash] opts the optional parameters
  ...
  describe 'measurements_id_put test' do
    it "should work" do
      # assertion here
      # should be_a()
      # should be_nil
  ...
  # unit tests for measurements_id_delete
  # Delete Measurement
  # Delete Measurement
  # @param id id of Measurement
  # @param [Hash] opts the optional parameters
  # @option opts [String] :access_token User&#39;s OAuth2 access token
  # @return [inline_response_200_2]
  describe 'measurements_id_delete test' do
    it "should work" do
      # assertion here
      # should be_a()
      # should be_nil
