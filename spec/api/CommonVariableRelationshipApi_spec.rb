...
# Unit tests for SwaggerClient::CommonVariableRelationshipApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CommonVariableRelationshipApi' do
  before do
    # run before each test
    @instance = SwaggerClient::CommonVariableRelationshipApi.new
  end
  ...
  describe 'test an instance of CommonVariableRelationshipApi' do
    it 'should create an instact of CommonVariableRelationshipApi' do
      @instance.should be_a(SwaggerClient::CommonVariableRelationshipApi)
    end
  end

  # unit tests for common_variable_relationships_get
  ...
  describe 'common_variable_relationships_get test' do
    it "should work" do
      # assertion here
      # should be_a()
      # should be_nil
  ...
  # unit tests for common_variable_relationships_post
  ...
  describe 'common_variable_relationships_post test' do
    it "should work" do
      # assertion here
      # should be_a()
      # should be_nil
  ...
  # unit tests for common_variable_relationships_id_get
  ...
  # @option opts [String] :access_token User&#39;s OAuth2 access token
  # @return [inline_response_200_13]
  describe 'common_variable_relationships_id_get test' do
    it "should work" do
      # assertion here
      # should be_a()
      # should be_nil
  ...
  # unit tests for common_variable_relationships_id_put
  ...
  describe 'common_variable_relationships_id_put test' do
    it "should work" do
      # assertion here
      # should be_a()
      # should be_nil
  ...
  # unit tests for common_variable_relationships_id_delete
  ...
  # @option opts [String] :access_token User&#39;s OAuth2 access token
  # @return [inline_response_200_2]
  describe 'common_variable_relationships_id_delete test' do
    it "should work" do
      # assertion here
      # should be_a()
      # should be_nil
