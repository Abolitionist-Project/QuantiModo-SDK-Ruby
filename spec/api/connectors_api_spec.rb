...
describe 'ConnectorsApi' do
  ...
  # unit tests for v1_connect_js_get
  ...
  # @return [nil]
  describe 'v1_connect_js_get test' do
    it "should work" do
  ...
  # unit tests for v1_connectors_connector_connect_get
  ...
  # @option opts [String] :access_token User&#39;s OAuth2 access token
  # @return [nil]
  describe 'v1_connectors_connector_connect_get test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for v1_connectors_connector_connect_instructions_get
  ...
  # @option opts [String] :access_token User&#39;s OAuth2 access token
  # @return [nil]
  describe 'v1_connectors_connector_connect_instructions_get test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for v1_connectors_connector_connect_parameter_get
  # Connect Parameter
  # Returns instructions that describe what parameters and endpoint to use to connect to the given data provider.
  # @param connector Lowercase system name of the source application or device. Get a list of available connectors from the /connectors/list endpoint.
  ...
  describe 'v1_connectors_connector_connect_parameter_get test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for v1_connectors_connector_disconnect_get
  # Delete stored connection info
  # The disconnect method deletes any stored tokens or connection information from the connectors database.
  # @param connector Lowercase system name of the source application or device. Get a list of available connectors from the /connectors/list endpoint.
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'v1_connectors_connector_disconnect_get test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for v1_connectors_connector_info_get
  ...
  describe 'v1_connectors_connector_info_get test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for v1_connectors_connector_update_get
  ...
  # @option opts [String] :access_token User&#39;s OAuth2 access token
  # @return [nil]
  describe 'v1_connectors_connector_update_get test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
