...
# Unit tests for SwaggerClient::SourceApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SourceApi' do
  before do
    # run before each test
    @instance = SwaggerClient::SourceApi.new
  end
  ...
  describe 'test an instance of SourceApi' do
    it 'should create an instact of SourceApi' do
      @instance.should be_a(SwaggerClient::SourceApi)
    end
  end

  # unit tests for sources_get
  ...
  # @option opts [String] :access_token User&#39;s OAuth2 access token
  # @return [inline_response_200_22]
  describe 'sources_id_get test' do
    it "should work" do
      # assertion here
      # should be_a()
      # should be_nil
  ...
  describe 'sources_id_put test' do
    it "should work" do
      # assertion here
      # should be_a()
      # should be_nil
  ...
  # unit tests for sources_id_delete
  # Delete Source
  # Delete Source
  # @param id id of Source
  # @param [Hash] opts the optional parameters
  # @option opts [String] :access_token User&#39;s OAuth2 access token
  # @return [inline_response_200_2]
  describe 'sources_id_delete test' do
    it "should work" do
      # assertion here
      # should be_a()
      # should be_nil
