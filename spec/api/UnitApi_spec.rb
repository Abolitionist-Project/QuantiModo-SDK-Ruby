...
# Unit tests for SwaggerClient::UnitApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UnitApi' do
  before do
    # run before each test
    @instance = SwaggerClient::UnitApi.new
  end
  ...
  describe 'test an instance of UnitApi' do
    it 'should create an instact of UnitApi' do
      @instance.should be_a(SwaggerClient::UnitApi)
    end
  end

  # unit tests for units_get
  ...
  # unit tests for units_id_delete
  # Delete Unit
  # Delete Unit
  # @param id id of Unit
  # @param [Hash] opts the optional parameters
  # @option opts [String] :access_token User&#39;s OAuth2 access token
  # @return [inline_response_200_2]
  describe 'units_id_delete test' do
    it "should work" do
      # assertion here
      # should be_a()
      # should be_nil
