...
# Unit tests for SwaggerClient::TrackingReminderApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TrackingReminderApi' do
  before do
    # run before each test
    @instance = SwaggerClient::TrackingReminderApi.new
  end
  ...
  describe 'test an instance of TrackingReminderApi' do
    it 'should create an instact of TrackingReminderApi' do
      @instance.should be_a(SwaggerClient::TrackingReminderApi)
    end
  end

  # unit tests for tracking_reminders_get
  ...
  describe 'tracking_reminders_get test' do
    it "should work" do
      # assertion here
      # should be_a()
      # should be_nil
  ...
  # unit tests for tracking_reminders_post
  ...
  describe 'tracking_reminders_post test' do
    it "should work" do
      # assertion here
      # should be_a()
      # should be_nil
  ...
  # unit tests for tracking_reminders_id_get
  ...
  # @option opts [String] :access_token User&#39;s OAuth2 access token
  # @return [inline_response_200_23]
  describe 'tracking_reminders_id_get test' do
    it "should work" do
      # assertion here
      # should be_a()
      # should be_nil
  ...
  # unit tests for tracking_reminders_id_put
  ...
  describe 'tracking_reminders_id_put test' do
    it "should work" do
      # assertion here
      # should be_a()
      # should be_nil
  ...
  # unit tests for tracking_reminders_id_delete
  ...
  # @option opts [String] :access_token User&#39;s OAuth2 access token
  # @return [inline_response_200_2]
  describe 'tracking_reminders_id_delete test' do
    it "should work" do
      # assertion here
      # should be_a()
      # should be_nil
