...
# Unit tests for SwaggerClient::ConnectorApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ConnectorApi' do
  before do
    # run before each test
    @instance = SwaggerClient::ConnectorApi.new
  end
  ...
  describe 'test an instance of ConnectorApi' do
    it 'should create an instact of ConnectorApi' do
      @instance.should be_a(SwaggerClient::ConnectorApi)
    end
  end
  ...
  # unit tests for connectors_id_get
  ...
  # @option opts [String] :access_token User&#39;s OAuth2 access token
  # @return [inline_response_200_16]
  describe 'connectors_id_get test' do
    it "should work" do
      # assertion here
      # should be_a()
      # should be_nil
  ...
  # unit tests for connectors_id_put
  # Update Connector
  # Update Connector
  # @param id id of Connector
  # @param [Hash] opts the optional parameters
  ...
  describe 'connectors_id_put test' do
    it "should work" do
      # assertion here
      # should be_a()
      # should be_nil
  ...
  # unit tests for connectors_id_delete
  # Delete Connector
  # Delete Connector
  # @param id id of Connector
  # @param [Hash] opts the optional parameters
  # @option opts [String] :access_token User&#39;s OAuth2 access token
  # @return [inline_response_200_2]
  describe 'connectors_id_delete test' do
    it "should work" do
      # assertion here
      # should be_a()
      # should be_nil
