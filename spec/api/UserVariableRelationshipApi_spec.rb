...
# Unit tests for SwaggerClient::UserVariableRelationshipApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UserVariableRelationshipApi' do
  before do
    # run before each test
    @instance = SwaggerClient::UserVariableRelationshipApi.new
  end
  ...
  describe 'test an instance of UserVariableRelationshipApi' do
    it 'should create an instact of UserVariableRelationshipApi' do
      @instance.should be_a(SwaggerClient::UserVariableRelationshipApi)
    end
  end

  # unit tests for user_variable_relationships_get
  ...
  describe 'user_variable_relationships_get test' do
    it "should work" do
      # assertion here
      # should be_a()
      # should be_nil
  ...
  # unit tests for user_variable_relationships_post
  ...
  describe 'user_variable_relationships_post test' do
    it "should work" do
      # assertion here
      # should be_a()
      # should be_nil
  ...
  # unit tests for user_variable_relationships_id_get
  ...
  # @option opts [String] :access_token User&#39;s OAuth2 access token
  # @return [inline_response_200_29]
  describe 'user_variable_relationships_id_get test' do
    it "should work" do
      # assertion here
      # should be_a()
      # should be_nil
  ...
  # unit tests for user_variable_relationships_id_put
  ...
  describe 'user_variable_relationships_id_put test' do
    it "should work" do
      # assertion here
      # should be_a()
      # should be_nil
  ...
  # unit tests for user_variable_relationships_id_delete
  ...
  # @option opts [String] :access_token User&#39;s OAuth2 access token
  # @return [inline_response_200_2]
  describe 'user_variable_relationships_id_delete test' do
    it "should work" do
      # assertion here
      # should be_a()
      # should be_nil
