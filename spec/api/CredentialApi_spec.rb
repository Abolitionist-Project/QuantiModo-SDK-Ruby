...
# Unit tests for SwaggerClient::CredentialApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CredentialApi' do
  before do
    # run before each test
    @instance = SwaggerClient::CredentialApi.new
  end
  ...
  describe 'test an instance of CredentialApi' do
    it 'should create an instact of CredentialApi' do
      @instance.should be_a(SwaggerClient::CredentialApi)
    end
  end

  # unit tests for credentials_get
  # Get all Credentials
  # Get all Credentials
  ...
  describe 'credentials_get test' do
    it "should work" do
      # assertion here
      # should be_a()
      # should be_nil
  ...
  # unit tests for credentials_post
  # Store Credential
  # Store Credential
  # @param [Hash] opts the optional parameters
  # @option opts [String] :access_token User&#39;s OAuth2 access token
  ...
  describe 'credentials_post test' do
    it "should work" do
      # assertion here
      # should be_a()
      # should be_nil
  ...
  # unit tests for credentials_id_get
  # Get Credential
  # Get Credential
  ...
  # @option opts [String] :access_token User&#39;s OAuth2 access token
  # @return [inline_response_200_19]
  describe 'credentials_id_get test' do
    it "should work" do
      # assertion here
      # should be_a()
      # should be_nil
  ...
  # unit tests for credentials_id_put
  # Update Credential
  # Update Credential
  # @param id connector id
  # @param attr_key attrKey
  ...
  describe 'credentials_id_put test' do
    it "should work" do
      # assertion here
      # should be_a()
      # should be_nil
  ...
  # unit tests for credentials_id_delete
  # Delete Credential
  # Delete Credential
  # @param id connector id
  # @param attr_key attrKey
  ...
  # @option opts [String] :access_token User&#39;s OAuth2 access token
  # @return [inline_response_200_2]
  describe 'credentials_id_delete test' do
    it "should work" do
      # assertion here
      # should be_a()
      # should be_nil
