...
# Unit tests for SwaggerClient::VoteApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'VoteApi' do
  before do
    # run before each test
    @instance = SwaggerClient::VoteApi.new
  end
  ...
  describe 'test an instance of VoteApi' do
    it 'should create an instact of VoteApi' do
      @instance.should be_a(SwaggerClient::VoteApi)
    end
  end

  # unit tests for votes_get
  # Get all Votes
  # Get all Votes
  ...
  # unit tests for votes_id_delete
  # Delete Vote
  ...
  # @option opts [String] :access_token User&#39;s OAuth2 access token
  # @return [inline_response_200_2]
  describe 'votes_id_delete test' do
    it "should work" do
      # assertion here
      # should be_a()
      # should be_nil
