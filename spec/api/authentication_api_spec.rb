...
describe 'AuthenticationApi' do
  ...
  # unit tests for v2_auth_social_authorize_code_get
  ...
  # @return [nil]
  describe 'v2_auth_social_authorize_code_get test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for v2_auth_social_authorize_token_get
  ...
  # @return [nil]
  describe 'v2_auth_social_authorize_token_get test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for v2_auth_social_login_get
  ...
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'v2_auth_social_login_get test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for v2_oauth2_access_token_get
  ...
  # @return [nil]
  describe 'v2_oauth2_access_token_get test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for v2_oauth_authorize_get
  ...
  # @option opts [String] :state An opaque string that is round-tripped in the protocol; that is to say, it is returned as a URI parameter in the Basic flow, and in the URI
  # @return [nil]
  describe 'v2_oauth_authorize_get test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
