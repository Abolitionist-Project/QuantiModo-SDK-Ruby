...
describe 'UpdateApi' do
  ...
  describe 'test an instance of UpdateApi' do
    it 'should create an instact of UpdateApi' do
      @instance.should be_a(SwaggerClient::UpdateApi)
    end
  end

  # unit tests for updates_get
  # Get all Updates
  # Get all Updates
  ...
  # @option opts [String] :access_token User&#39;s OAuth2 access token
  # @return [inline_response_200_28]
  describe 'updates_id_get test' do
    it "should work" do
      # assertion here
      # should be_a()
      # should be_nil
  ...
  describe 'updates_id_put test' do
    it "should work" do
      # assertion here
      # should be_a()
      # should be_nil
  ...
  # unit tests for updates_id_delete
  # Delete Update
  # Delete Update
  # @param id id of Update
  # @param [Hash] opts the optional parameters
  # @option opts [String] :access_token User&#39;s OAuth2 access token
  # @return [inline_response_200_2]
  describe 'updates_id_delete test' do
    it "should work" do
      # assertion here
      # should be_a()
      # should be_nil
