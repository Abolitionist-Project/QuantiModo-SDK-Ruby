...
# Unit tests for SwaggerClient::VariableApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'VariableApi' do
  before do
    # run before each test
    @instance = SwaggerClient::VariableApi.new
  end
  ...
  describe 'test an instance of VariableApi' do
    it 'should create an instact of VariableApi' do
      @instance.should be_a(SwaggerClient::VariableApi)
    end
  end

  # unit tests for variables_get
  # Get all Variables
  # Get all Variables
  ...
  describe 'variables_get test' do
    it "should work" do
      # assertion here
      # should be_a()
      # should be_nil
  ...
  describe 'variables_post test' do
    it "should work" do
      # assertion here
      # should be_a()
      # should be_nil
  ...
  # unit tests for variables_id_get
  # Get Variable
  # Get Variable
  ...
  # @option opts [String] :access_token User&#39;s OAuth2 access token
  # @return [inline_response_200_35]
  describe 'variables_id_get test' do
    it "should work" do
      # assertion here
      # should be_a()
      # should be_nil
  ...
  # unit tests for variables_id_put
  # Update Variable
  # Update Variable
  # @param id id of Variable
  # @param [Hash] opts the optional parameters
  ...
  describe 'variables_id_put test' do
    it "should work" do
      # assertion here
      # should be_a()
      # should be_nil
  ...
  # unit tests for variables_id_delete
  # Delete Variable
  # Delete Variable
  # @param id id of Variable
  # @param [Hash] opts the optional parameters
  # @option opts [String] :access_token User&#39;s OAuth2 access token
  # @return [inline_response_200_2]
  describe 'variables_id_delete test' do
    it "should work" do
      # assertion here
      # should be_a()
      # should be_nil
