...
# Unit tests for SwaggerClient::VariableCategoryApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'VariableCategoryApi' do
  before do
    # run before each test
    @instance = SwaggerClient::VariableCategoryApi.new
  end
  ...
  describe 'test an instance of VariableCategoryApi' do
    it 'should create an instact of VariableCategoryApi' do
      @instance.should be_a(SwaggerClient::VariableCategoryApi)
    end
  end

  # unit tests for variable_categories_get
  ...
  describe 'variable_categories_get test' do
    it "should work" do
      # assertion here
      # should be_a()
      # should be_nil
  ...
  # unit tests for variable_categories_post
  ...
  describe 'variable_categories_post test' do
    it "should work" do
      # assertion here
      # should be_a()
      # should be_nil
  ...
  # unit tests for variable_categories_id_get
  ...
  # @option opts [String] :access_token User&#39;s OAuth2 access token
  # @return [inline_response_200_32]
  describe 'variable_categories_id_get test' do
    it "should work" do
      # assertion here
      # should be_a()
      # should be_nil
  ...
  # unit tests for variable_categories_id_put
  ...
  describe 'variable_categories_id_put test' do
    it "should work" do
      # assertion here
      # should be_a()
      # should be_nil
  ...
  # unit tests for variable_categories_id_delete
  ...
  # @option opts [String] :access_token User&#39;s OAuth2 access token
  # @return [inline_response_200_2]
  describe 'variable_categories_id_delete test' do
    it "should work" do
      # assertion here
      # should be_a()
      # should be_nil
