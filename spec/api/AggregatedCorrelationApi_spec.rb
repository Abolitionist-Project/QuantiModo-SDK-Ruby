...
# Unit tests for SwaggerClient::AggregatedCorrelationApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AggregatedCorrelationApi' do
  before do
    # run before each test
    @instance = SwaggerClient::AggregatedCorrelationApi.new
  end
  ...
  describe 'test an instance of AggregatedCorrelationApi' do
    it 'should create an instact of AggregatedCorrelationApi' do
      @instance.should be_a(SwaggerClient::AggregatedCorrelationApi)
    end
  end

  # unit tests for aggregated_correlations_get
  ...
  describe 'aggregated_correlations_get test' do
    it "should work" do
      # assertion here
      # should be_a()
      # should be_nil
  ...
  # unit tests for aggregated_correlations_post
  ...
  describe 'aggregated_correlations_post test' do
    it "should work" do
      # assertion here
      # should be_a()
      # should be_nil
  ...
  # unit tests for aggregated_correlations_id_get
  ...
  # @option opts [String] :access_token User&#39;s OAuth2 access token
  # @return [inline_response_200_1]
  describe 'aggregated_correlations_id_get test' do
    it "should work" do
      # assertion here
      # should be_a()
      # should be_nil
  ...
  # unit tests for aggregated_correlations_id_put
  ...
  describe 'aggregated_correlations_id_put test' do
    it "should work" do
      # assertion here
      # should be_a()
      # should be_nil
  ...
  # unit tests for aggregated_correlations_id_delete
  ...
  # @option opts [String] :access_token User&#39;s OAuth2 access token
  # @return [inline_response_200_2]
  describe 'aggregated_correlations_id_delete test' do
    it "should work" do
      # assertion here
      # should be_a()
      # should be_nil
