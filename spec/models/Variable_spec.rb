...
describe 'Variable' do
  ...
  describe 'test attribute "number_of_unique_values"' do
    it 'should work' do
       # assertion here
       # should be_a()
       # should be_nil
  ...
  describe 'test attribute "number_of_user_variables"' do
    it 'should work' do
       # assertion here
       # should be_a()
       # should be_nil
  ...
  describe 'test attribute "maximum_recorded_value"' do
    it 'should work' do
       # assertion here
       # should be_a()
       # should be_nil
