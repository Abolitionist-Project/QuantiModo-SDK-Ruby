...
describe 'MeasurementExport' do
  before do
    # run before each test
    @instance = SwaggerClient::MeasurementExport.new
  end
  ...
  describe 'test an instance of MeasurementExport' do
    it 'should create an instact of MeasurementExport' do
      @instance.should be_a(SwaggerClient::MeasurementExport) 
    end
  end
