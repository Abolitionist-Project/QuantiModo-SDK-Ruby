...
describe 'MeasurementValue' do
  before do
    # run before each test
    @instance = SwaggerClient::MeasurementValue.new
  end
  ...
  describe 'test an instance of MeasurementValue' do
    it 'should create an instact of MeasurementValue' do
      @instance.should be_a(SwaggerClient::MeasurementValue) 
    end
  end
