...
describe 'AggregatedCorrelation' do
  before do
    # run before each test
    @instance = SwaggerClient::AggregatedCorrelation.new
  end
  ...
  describe 'test an instance of AggregatedCorrelation' do
    it 'should create an instact of AggregatedCorrelation' do
      @instance.should be_a(SwaggerClient::AggregatedCorrelation) 
    end
  end
  ...
  describe 'test attribute "correlation"' do
    it 'should work' do
       # assertion here
       # should be_a()
       # should be_nil
  ...
  describe 'test attribute "cause_id"' do
    it 'should work' do
       # assertion here
       # should be_a()
       # should be_nil
  ...
  describe 'test attribute "cause_unit_id"' do
    it 'should work' do
       # assertion here
       # should be_a()
       # should be_nil
  ...
  describe 'test attribute "aggregate_qm_score"' do
    it 'should work' do
       # assertion here
       # should be_a()
       # should be_nil
  ...
  describe 'test attribute "reverse_pearson_correlation_coefficient"' do
    it 'should work' do
       # assertion here
       # should be_a()
       # should be_nil
  ...
  describe 'test attribute "predictive_pearson_correlation_coefficient"' do
    it 'should work' do
       # assertion here
       # should be_a()
       # should be_nil
