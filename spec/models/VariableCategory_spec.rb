...
describe 'VariableCategory' do
  before do
    # run before each test
    @instance = SwaggerClient::VariableCategory.new
  end
  ...
  describe 'test an instance of VariableCategory' do
    it 'should create an instact of VariableCategory' do
      @instance.should be_a(SwaggerClient::VariableCategory) 
    end
  end
