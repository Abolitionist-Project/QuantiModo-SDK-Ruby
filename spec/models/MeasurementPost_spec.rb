...
describe 'MeasurementPost' do
  before do
    # run before each test
    @instance = SwaggerClient::MeasurementPost.new
  end
  ...
  describe 'test an instance of MeasurementPost' do
    it 'should create an instact of MeasurementPost' do
      @instance.should be_a(SwaggerClient::MeasurementPost) 
    end
  end
