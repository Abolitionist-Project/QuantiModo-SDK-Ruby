...
describe 'CommonVariableRelationship' do
  before do
    # run before each test
    @instance = SwaggerClient::CommonVariableRelationship.new
  end
  ...
  describe 'test an instance of CommonVariableRelationship' do
    it 'should create an instact of CommonVariableRelationship' do
      @instance.should be_a(SwaggerClient::CommonVariableRelationship) 
    end
  end
