...
describe 'Connection' do
  ...
  describe 'test an instance of Connection' do
    it 'should create an instact of Connection' do
      @instance.should be_a(SwaggerClient::Connection) 
    end
  end
  ...
  describe 'test attribute "connect_status"' do
    it 'should work' do
       # assertion here
       # should be_a()
       # should be_nil
  ...
  describe 'test attribute "connect_error"' do
    it 'should work' do
       # assertion here
       # should be_a()
       # should be_nil
  ...
  describe 'test attribute "update_requested_at"' do
    it 'should work' do
       # assertion here
       # should be_a()
       # should be_nil
  ...
  describe 'test attribute "update_error"' do
    it 'should work' do
       # assertion here
       # should be_a()
       # should be_nil
  ...
  describe 'test attribute "last_successful_updated_at"' do
    it 'should work' do
       # assertion here
       # should be_a()
       # should be_nil
