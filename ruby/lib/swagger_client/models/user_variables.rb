...
module SwaggerClient
  ...
  class UserVariables
    ...
    def hash
      [user, variable_id, duration_of_action, filling_value, join_with, maximum_allowed_value, minimum_allowed_value, onset_delay, experiment_start_time, experiment_end_time, _alias].hash
    end
