...
module SwaggerClient
  ...
  class Unit
    ...
    def list_invalid_properties
      ...
      if @abbreviated_name.nil?
        invalid_properties.push("invalid value for 'abbreviated_name', abbreviated_name cannot be nil.")
      end
      ...
      if @conversion_steps.nil?
        invalid_properties.push("invalid value for 'conversion_steps', conversion_steps cannot be nil.")
      end
    ...
    def hash
      [name, abbreviated_name, category, minimum_allowed_value, maximum_allowed_value, conversion_steps].hash
    end
