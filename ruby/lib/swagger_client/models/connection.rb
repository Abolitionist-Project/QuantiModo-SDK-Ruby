...
module SwaggerClient
  ...
  class Connection
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'connectStatus')
        self.connect_status = attributes[:'connectStatus']
      end

      if attributes.has_key?(:'connectError')
        self.connect_error = attributes[:'connectError']
      end

      if attributes.has_key?(:'updateRequestedAt')
        self.update_requested_at = attributes[:'updateRequestedAt']
      end
      ...
      if attributes.has_key?(:'updateError')
        self.update_error = attributes[:'updateError']
      end

      if attributes.has_key?(:'lastSuccessfulUpdatedAt')
        self.last_successful_updated_at = attributes[:'lastSuccessfulUpdatedAt']
      end
